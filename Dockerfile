...
LABEL "Run with ENV file"="docker run --rm --env-file ENV -ti quay.io/paulwilljones/slack-pom"
LABEL "Run with ENV variables"="docker run --rm -e SLACK_API_TOKEN=\${SLACK_API_TOKEN} -e SLACK_USER=\${SLACK_USER} -ti quay.io/paulwilljones/slack-pom"
